...
<form method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input id="movie_id" name="movie_id" placeholder="Movie ID" class="form-control input-md" required=""
                   type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input id="movie_name" name="movie_name" placeholder="NAME" class="form-control input-md" required=""
                   type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input id="movie_director" name="movie_director" placeholder="DIRECTOR" class="form-control input-md"
                   required="" type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input id="movie_time" name="movie_time" placeholder="TIME" class="form-control input-md" required=""
                   type="text">
